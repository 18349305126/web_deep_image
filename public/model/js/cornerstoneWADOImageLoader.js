...
function decodeImageFrame(imageFrame, transferSyntax, pixelData, canvas) {
  ...
  if (transferSyntax === '1.2.840.10008.1.2') {
    ...
    // console.log(transferSyntax,1662)
    return addDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === '1.2.840.10008.1.2.2') {
  	console.log(transferSyntax,1665)
...
var defaultConfig = {
  ...
  webWorkerPath: '/models/js/cornerstoneWADOImageLoaderWebWorker.js',
  webWorkerTaskPaths: [],
  taskConfiguration: {
    decodeTask: {
      loadCodecsOnStartup: true,
      initializeCodecsOnStartup: false,
      codecsPath: '/models/js/cornerstoneWADOImageLoaderCodecs.js',
      usePDFJS: false,
